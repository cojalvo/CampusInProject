...
/**
 * This Class is responsible to Access the DB and map between our map location
...
public class DataBaseHealper extends SQLiteOpenHelper implements IDataBaseHealper
{
	...
	// add it to the DB by calling the
	// "addNewLocation(JacocDBLocation toAdd)"
	...
	String CREATE_LOCATION_TABLE = "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY AUTOINCREMENT," + LOCATION_NAME + " TEXT, " + NE_REAL_LAT + " REAL," + NE_REAL_LNG
		+ " REAL," + SW_REAL_LAT + " REAL," + SW_REAL_LNG + " REAL," + NE_MAP_LAT + " INTEGER," + NE_MAP_LNG + " INTEGER," + SW_MAP_LAT + " INTEGER," + SW_MAP_LNG
		+ " INTEGER," + HIGH_SPEC + " REAL," + LOW_SPEC + " REAL)";
