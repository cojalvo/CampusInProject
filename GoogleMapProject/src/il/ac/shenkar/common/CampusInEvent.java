...
/**
 * This class represent an event in the campus There are many kind of event as
 * describe in the CampusInEventType
 * 
 * @author cadan
 * 
 */
public class CampusInEvent extends CampusInElement
{
    ...
    // global events will be available for all, only the owner can delete the
    // event
    private boolean isGlobal;
    // the user that receive the event, if there is no receiver this will be the
    // same as
    // the owner id
